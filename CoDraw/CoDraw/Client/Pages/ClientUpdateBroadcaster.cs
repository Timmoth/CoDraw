...
public class ClientUpdateBroadcaster : UpdateBroadcaster
{
    ...
    public ClientUpdateBroadcaster(ILogger<UpdateBroadcaster> logger, ClientHub hubContext, IBroadcastTimer timer,
        UserEventBuilder userEventBuilder) : base(logger, timer)
    {
